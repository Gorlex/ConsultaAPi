...
export class CountPage {
  ...
  listA:object = {error: true, data: []}; //variable creada que va a contener la consulta del API
  ...
  getArticle(){
    this.rest.getArticles().subscribe((res:any) => {
//codigo agregado
if (res) {
  this.listA = {error: false, data: res};
  console.log(typeof this.listA, this.listA)
}
//fin codigo agregado
        //console.log(res);
    })
